...
// This added from a request by WP Residence install
// define( ‘WP_MEMORY_LIMIT’, ‘256’);

// ** MySQL settings - You can get this info from your web host ** //
/** The name of the database for WordPress */
define( 'DB_NAME', 'wp_WPResidenceRobertDuff' );

/** MySQL database username */
define( 'DB_USER', 'wp_WPResidenceRobertDuff' );

/** MySQL database password */
define( 'DB_PASSWORD', 'wp_WPResidenceRobertDuff' );
