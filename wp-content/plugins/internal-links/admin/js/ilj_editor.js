(function($) {
    $.fn.ilj_editor = function() {
        ...
        var Box = {
            ...
            keywordInputInfo: $('<span class="dashicons dashicons-info"></span>').css({'margin-top': '10px'}).tipso({
                content: $(
                    '<ul>'+
            ...
            gapInputInfo: $('<span class="dashicons dashicons-info"></span>').tipso({
                content: $(
            ...
            init: function() {
                ...
                this.inputField.attr('type', 'hidden').parent('p').hide();
                this.clearError();

                elem.find('.inside').append(this.errorMessage, this.inputGui, this.keywordViewGui, this.helpMessage);
                elem.find('>h2 span').prepend($('<i/>').addClass('icon icon-ilj'));

                this.initKeywords();
                this.syncGui();
                this.inputGui.find('.tip').tipso(tipsoConfig);
            ...
            syncGui: function() {
                ...
                if (this.keywords.length > 0) {
                    ...
                    that.keywordViewGui.find('.tip').tipso(tipsoConfig);
                } else {
