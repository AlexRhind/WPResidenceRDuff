...
jQuery(document).ready(function() {
    jQuery('#ilj_settings_field_editor_role, #ilj_settings_field_index_generation, #ilj_settings_field_whitelist, #ilj_settings_field_taxonomy_whitelist, #ilj_settings_field_keyword_order, #ilj_settings_field_no_link_tags').ilj_select2({
    ...
    jQuery('#ilj_settings_field_multiple_keywords').change(function() {
